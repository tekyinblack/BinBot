    ...
    def steerpage(self):
        ...
        html =  """
            ...
            <body>
                ...
                onmousedown="sndCmd('OPEN');" ontouchstart="sndCmd('OPEN');"
                >Open</button></td>
                <td align="center"><button class="button" 
                onmousedown="sndCmd('CLOSE');" ontouchstart="sndCmd('CLOSE');"
                >Close</button></td></tr>
                <tr><td colspan="2" align="center"><button class="button" 
